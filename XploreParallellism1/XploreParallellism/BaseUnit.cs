...
namespace XploreParallellism1 {
    [SetUpFixture]
    public class BaseUnit {
        public static string configFile = @"C:\Users\git\source\XploreParallellism1\Config1.json";
        public int number1;
        public int number2;
        ...
        public void OneTimeSetUp() {
            ...
            string appiumCommand = jo["appiumCMD"].ToString().Replace("{0}", @"C:\Users\git\source\XploreParallellism1\appiumServerLogs.json").Replace("{1}", appiumPort);
